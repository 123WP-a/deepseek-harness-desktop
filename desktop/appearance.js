...
let yaml = null
try {
  // Same resolution order as the server runtime: the bundled closure
  // (resources/runtime when packaged, desktop/runtime in dev), then the dev
  // layout's own node_modules. A missing parser is not fatal — we fall back
  // to 'system'.
...
module.exports = { startAppearanceSync, applyPreference }
